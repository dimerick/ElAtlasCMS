...
layers.push(CartoDB_DarkMatter);
        ...
        // L.control.iconL
        var map = L.map('map', {
            center: [6.307833873953841, -75.57373881340028],
            zoom: 17,
            maxZoom: 18,
            minZoom: 3,
        ...
        function getPuntos(){
            jQuery.ajax({
                ...
                success: function (data, textStatus, jqXHR){
                    ...
                    santanderJson = JSON.parse(JSON.stringify(santander));
                    
                    var santanderMap = L.Proj.geoJson(santanderJson,{
                        onEachFeature: eachSantander
                    });
...
function eachSantander(feature, layer){
            if(layer != null){
            // console.log(feature);
