...
//                console.log(layer);
                ...
                if(feature.geometry.properties.foto){
                    image = '<img src="/static/images/elatlas/grupos/'+feature.geometry.properties.foto+'">'
                }
                ...
                var content = '<div class="content-info-marker">' + title +
                    ...
                    '<li> <i class="fa fa-caret-right"></i> <span><b>Descripción: </b>'+' '+feature.geometry.properties.description+'</span></li>' +
                    '</ul>' + 
                    image
